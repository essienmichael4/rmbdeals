    ...
    return (
        <div className="mx-auto container flex flex-col items-center justify-between h-screen px-4 py-16">
            ...
            <div className="flex flex-col items-center">
                ...
                { !auth?.user ?  
                    <Link to={"../rmbdeals"} className="bg-black/90 hover:bg-black py-2 px-4 rounded text-white mt-4">Back to Home Page</Link>
                    : auth.user.role === "USER" ?
                        <Link to={"../rmbdeals/dashboard"} className="bg-black/90 hover:bg-black py-2 px-4 rounded text-white mt-4">Go to dashboard</Link>
                        :
                        <Link to={"../rmbdeals/co/administrator/dashboard"} className="bg-black/90 hover:bg-black py-2 px-4 rounded text-white mt-4">Go to dashboard</Link>
                }
            </div>
            <div className="flex flex-col items-center">
