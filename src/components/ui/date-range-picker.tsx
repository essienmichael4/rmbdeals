  ...
  return (
    ...
    >
      <PopoverTrigger asChild>
        <Button size={'lg'} variant="outline" className='bg-transparent hover:bg-black/20'>
          <div className="text-right text-white bg-transparent">
            ...
            {rangeCompare != null && (
              <div className="opacity-60 text-white text-xs -mt-1">
                <>
          ...
          <div className="pl-1 text-white opacity-60 -mr-2 scale-125">
